    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_purpose', models.CharField(choices=[('Road', 'Road'), ('Water', 'Water'), ('Air', 'Air')], default='Road', max_length=20)),
                ('condition', models.CharField(choices=[('Factory New', 'Factory New'), ('Minimal Wear', 'Minimal Wear'), ('Field Tested', 'Field Tested'), ('Battle Scarred', 'Battle Scarred')], default='Minimal Wear', max_length=40)),
